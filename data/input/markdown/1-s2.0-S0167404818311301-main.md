...
# Definition 2.6 (Package Dependency Graph (PkgDG))
...
|TPL|Amazon s3|Amazon s3∗|Apache Email|Apache Ftp|Gson|Flurry|OkHttp|Nine Old Androids|Google Cloud Messaging|Picasso|Http Billing| |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
